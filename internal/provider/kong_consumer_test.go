...
func TestAccKongConsumerDataSource(t *testing.T) {
	statechecks := []statecheck.StateCheck{
		assertStringValue("data.kong_consumer.test", "id", "068141a0-93c3-4286-8329-97a95b9fe22d"),
		assertStringValue("data.kong_consumer.test", "username", "test"),
		assertNullValue("data.kong_consumer.test", "custom_id"),
		assertNullValue("data.kong_consumer.test", "tags"),
	}
